...
public class OpportunityContact {
    ...
    @XmlElementRef(name = "PersonCentricJobTitle", namespace = "http://xmlns.oracle.com/apps/sales/opptyMgmt/opportunities/opportunityService/", type = JAXBElement.class)
    protected JAXBElement<String> personCentricJobTitle;
    @XmlElementRef(name = "DoNotContactFlag", namespace = "http://xmlns.oracle.com/apps/sales/opptyMgmt/opportunities/opportunityService/", type = JAXBElement.class)
    ...
    public void setPersonCentricJobTitle(JAXBElement<String> value) {
        this.personCentricJobTitle = ((JAXBElement<String> ) value);
    }
