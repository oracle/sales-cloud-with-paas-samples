...
package com.oracle.ptsdemo.healthcare.wsclient.healthcare.generated;
 ...
 * generated in the com.oracle.ptsdemo.healthcare.wsclient.healthcare.generated package. 
...
public class ObjectFactory {
    ...
    private final static QName _RequestOrderStatusResponse_QNAME = new QName("http://ws.healthcare.ptsdemo.oracle.com/", "requestOrderStatusResponse");
    private final static QName _LoadPrescription_QNAME = new QName("http://ws.healthcare.ptsdemo.oracle.com/", "loadPrescription");
    private final static QName _IsMedicationReadyToPickupResponse_QNAME = new QName("http://ws.healthcare.ptsdemo.oracle.com/", "isMedicationReadyToPickupResponse");
    private final static QName _SetMedicationReadyToPickup_QNAME = new QName("http://ws.healthcare.ptsdemo.oracle.com/", "setMedicationReadyToPickup");
    private final static QName _IsMedicationReadyToPickup_QNAME = new QName("http://ws.healthcare.ptsdemo.oracle.com/", "isMedicationReadyToPickup");
    private final static QName _LoadPrescriptionResponse_QNAME = new QName("http://ws.healthcare.ptsdemo.oracle.com/", "loadPrescriptionResponse");
    private final static QName _RequestOrderStatus_QNAME = new QName("http://ws.healthcare.ptsdemo.oracle.com/", "requestOrderStatus");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.oracle.ptsdemo.healthcare.wsclient.healthcare.generated
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.healthcare.ptsdemo.oracle.com/", name = "requestOrderStatusResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.healthcare.ptsdemo.oracle.com/", name = "loadPrescription")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.healthcare.ptsdemo.oracle.com/", name = "isMedicationReadyToPickupResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.healthcare.ptsdemo.oracle.com/", name = "setMedicationReadyToPickup")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.healthcare.ptsdemo.oracle.com/", name = "isMedicationReadyToPickup")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.healthcare.ptsdemo.oracle.com/", name = "loadPrescriptionResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.healthcare.ptsdemo.oracle.com/", name = "requestOrderStatus")
