...
public class HealthCareLoadClient extends ObjectClient {
    ...
    private void init() {
        ...
        System.out.println("HealthCareLoadClient.init is called***************************");
        String username =
        ...
        try {
            ...
            wsdlURL =
             new URL(httpString + "://" + FusionConfig.getInstance().getProperty("HEALTHCARE_URL") +
                    "/HealthCare/HealthCareLoadPort?WSDL");
    ...
    public List<String> getMedicationList(){
        System.out.println("HealthCareLoadClient.getMedicationList is called");
    ...
    public List<Medication> getMedicationDetailList(){
        ...
        System.out.println("getMedicationDetailList ****************");
        ...
        List<com.oracle.pts.healthcare.load.wsclient.generated.Medication>  medicationDetailList =  healthCareLoad.getMedicationDetailList();
            System.out.println("back from getMedicationDetailList ****************");
