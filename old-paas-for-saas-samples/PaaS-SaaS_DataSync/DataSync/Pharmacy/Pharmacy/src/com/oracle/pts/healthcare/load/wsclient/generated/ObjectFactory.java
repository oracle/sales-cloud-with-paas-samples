...
package com.oracle.pts.healthcare.load.wsclient.generated;
 ...
 * generated in the com.oracle.pts.healthcare.load.wsclient.generated package. 
...
public class ObjectFactory {
    ...
    private final static QName _CreateMedication_QNAME = new QName("http://healthcare.webservice.pts.oracle.com/", "createMedication");
    private final static QName _GetMedicationDetailListResponse_QNAME = new QName("http://healthcare.webservice.pts.oracle.com/", "getMedicationDetailListResponse");
    private final static QName _GetMedicationList_QNAME = new QName("http://healthcare.webservice.pts.oracle.com/", "getMedicationList");
    private final static QName _GetMedicationListResponse_QNAME = new QName("http://healthcare.webservice.pts.oracle.com/", "getMedicationListResponse");
    private final static QName _CreatePrescriptionResponse_QNAME = new QName("http://healthcare.webservice.pts.oracle.com/", "createPrescriptionResponse");
    private final static QName _GetMedicationDetailList_QNAME = new QName("http://healthcare.webservice.pts.oracle.com/", "getMedicationDetailList");
    private final static QName _CreatePrescription_QNAME = new QName("http://healthcare.webservice.pts.oracle.com/", "createPrescription");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.oracle.pts.healthcare.load.wsclient.generated
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://healthcare.webservice.pts.oracle.com/", name = "createMedication")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://healthcare.webservice.pts.oracle.com/", name = "getMedicationDetailListResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://healthcare.webservice.pts.oracle.com/", name = "getMedicationList")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://healthcare.webservice.pts.oracle.com/", name = "getMedicationListResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://healthcare.webservice.pts.oracle.com/", name = "createPrescriptionResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://healthcare.webservice.pts.oracle.com/", name = "getMedicationDetailList")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://healthcare.webservice.pts.oracle.com/", name = "createPrescription")
