...
@XmlType(name = "RevenuePartner", propOrder = {
    "optyId",
    "partOrgPartyId",
    "partProgramId",
    "partTypeCd",
...
public class RevenuePartner {
    ...
    @XmlElement(name = "RevnPartnerNumber")
    protected String revnPartnerNumber;
     ...
     *     
     */
    public String getRevnPartnerNumber() {
     ...
     *     
     */
    public void setRevnPartnerNumber(String value) {
