...
@WebServiceClient(wsdlLocation="http://localhost:7101/HealthCare-HealthCare-context-root/HealthCareLoadPort?WSDL",
  ...
  extends Service
{
  ...
  static
  {
    try
    {
      ...
      {
        wsdlLocationURL =
            HealthCareLoadService.class.getResource("http://localhost:7101/HealthCare-HealthCare-context-root/HealthCareLoadPort?WSDL");
        if (wsdlLocationURL == null)
        {
          baseUrl = new File(".").toURL();
          wsdlLocationURL =
              new URL(baseUrl, "http://localhost:7101/HealthCare-HealthCare-context-root/HealthCareLoadPort?WSDL");
        }
      }
      else
      {
    ...
    catch (MalformedURLException e)
    {
      logger.log(Level.ALL,
          "Failed to create wsdlLocationURL using http://localhost:7101/HealthCare-HealthCare-context-root/HealthCareLoadPort?WSDL",
          e);
    }
  }
