 ...
 *         &lt;element name="bindPartyUsageCode" type="{http://www.w3.org/2001/XMLSchema}string"/>
...
@XmlRootElement(name = "getPersonsFilteredByPartyUsageCodeAsync")
public class GetPersonsFilteredByPartyUsageCodeAsync {

    @XmlElement(required = true)
    protected FindCriteria findCriteria;
    @XmlElement(required = true)
    protected String bindPartyUsageCode;
    @XmlElement(required = true)
    ...
    /**
     * Gets the value of the bindPartyUsageCode property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getBindPartyUsageCode() {
        return bindPartyUsageCode;
    }

    /**
     * Sets the value of the bindPartyUsageCode property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setBindPartyUsageCode(String value) {
        this.bindPartyUsageCode = value;
    }
