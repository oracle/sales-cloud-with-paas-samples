...
public class DataSet {
    ...
    public DataSet getDecendentDataSet(String objectName){
        ...
        rDataSet = getDecendentDataSet(this,objectName);
        return rDataSet;
    }
    private DataSet getDecendentDataSet(DataSet dataSet,String objectName){
        DataSet rDataSet = null;
        
        
        System.out.println("objectName " + dataSet.getName());
        
        if(dataSet.getName().equals(objectName)){
            
            rDataSet = dataSet;
        }
        else{
            for(DataSet cDataSet:dataSet.getChildDataSet()){
                rDataSet = getDecendentDataSet(cDataSet,objectName);
                if(rDataSet!=null){
                    break;
                }
            }
